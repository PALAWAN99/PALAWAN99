        ...
        <Stack gap="md">
          <Stack gap="sm">
            <Group grow wrap={isMobile ? 'wrap' : 'nowrap'}>
              <TextInput
                label={t('Gate.code')}
                placeholder={t('Gate.pennuengCodePlaceholder')}
                description={t('Gate.pennuengCodeHint')}
                required
                readOnly={gateCodeReadOnly}
