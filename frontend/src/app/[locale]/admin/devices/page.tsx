...
export default function DevicesPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setGates(gatesData.map((g: any) => ({ value: g.id, label: `${g.nameTh} (${g.gateCode})` })));
    } catch (error) {
  ...
  return (
    <Stack gap="lg">
      <Group justify="space-between" align="flex-end">
        <div>
          <Title order={2} c="var(--text-primary)">{t('Device.title')}</Title>
          <Text size="sm" c="var(--text-secondary)">{t('Device.subtitle')}</Text>
        </div>
        <Group>
                        ...
                        <Menu.Item 
                          ...
                          onClick={() => {
                            ...
                            form.setValues({
                              ...
                              secret: '', // Don't show existing hash
                            });
                            setModalOpen(true);
                          }}
                        >
        ...
        <form onSubmit={form.onSubmit(handleSubmit)}>
          <Stack gap="md">
            ...
            <Group justify="flex-end" mt="xl">
              ...
              <Button type="submit">
                {editingDevice ? t('Common.save') : t('Common.confirm')}
              </Button>
            </Group>
          </Stack>
        </form>
