  ...
  return (
    <Stack gap="lg">
      <Group justify="space-between" align="flex-end">
        <div>
          <Title order={2}>@@@�@�@�@@"@@�@@@�@@�@� (Thai ID Card)</Title>
...
@@@�@�@@"@@�@�@@�@@�@@@�@@"@�@�'}
                      ...
                      <Stack gap={4} w="100%">
                        {isReading && (
                          <Text size="xs" c="green" fw={500} ta="center">@�@@@@�@
@@�@@
@@@�@@�@
@@@@�@@�@@@�@...</Text>
                        )}
              ...
              <Grid gutter="md">
                <Grid.Col span={{ base: 12, md: 6 }}>
                  <Paper withBorder p="md" radius="md">
                    <Stack gap="xs">
                      <Text fw={600} size="sm">Vendor IDs @@@�@@@�@@@�</Text>
                      <Group gap="xs">
                      ...
                      <Text size="xs" c="dimmed" mt="xs">
                        @�@@@
@@@@@@�@�@@�@ Vendor ID @�@�@@�@@�@"@@@�@@�@�@�@�@�@@� `src/lib/idcard/reader.ts`
                      </Text>
                    </Stack>
                  </Paper>
                </Grid.Col>
...
@�@�@� QR Code @@�@@�@@�@@�<br/>@�@�@@�@@@@� E-Ticket @@�@�@�@�@�@@@�@@�@�@@�@�@@
          ...
          <Stack align="center" gap={4}>
            ...
            <Text size="sm" c="dimmed">
              @�@@�@�@@"@: {activeTab === 'manual' ? manualData.citizenId : cardData?.citizenId}
            </Text>
          </Stack>
