import { SimpleGrid, Card, Group, Text, Badge, Stack, Paper, Box } from '@mantine/core';
...
export function DashboardActivity({ recentEvents, gateStatus, t }: DashboardActivityProps) {
  return (
