...
export default function BranchManagement() {
  ...
  const form = useForm({
    ...
    validate: {
      code: (value) => (value.length < 2 ? 'Code must be at least 2 characters' : null),
      nameTh: (value) => (value.length < 1 ? 'Required' : null),
      nameEn: (value) => (value.length < 1 ? 'Required' : null),
      nameZh: (value) => (value.length < 1 ? 'Required' : null),
    },
  });
